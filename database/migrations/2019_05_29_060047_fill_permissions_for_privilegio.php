...
class FillPermissionsForPrivilegio extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPrivilegio constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.privilegio',
            'admin.privilegio.index',
            'admin.privilegio.create',
            'admin.privilegio.show',
            'admin.privilegio.edit',
            'admin.privilegio.delete',
        ]);
